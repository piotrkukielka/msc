...
//    return sin(t);
    ...
    // plan:
    // zalozyc, ze mam jakies dane na kazdy temat. jezeli trzeba to wymyslic
    // odpalic na tych wymyslontych danych i wyslac
    double k20 = 0.23;  // d^-1, or less
    double k_alpha = k20*pow(1.047, (temp(t) - 20));

    double const L = 4.5;  //  mg/L

    double r1 = -k_alpha*L;

    ///////////////////////////////////////////////////////////////////
    double h = 0.75;  // m, probably should be variable
